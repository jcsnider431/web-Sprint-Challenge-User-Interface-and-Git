...
1. If you were to describe semantic HTML to the next cohort of students, what would you say?
 Semantic HTML is creating element and tags with perpose in mind using seactions and div properly.

2. Name two big differences between ```display: block;``` and ```display: inline;```.
Display inline follows set height and with from parent in link
Display block creates blocks that sit beside one another.
